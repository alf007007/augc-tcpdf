...
$tabla_titulo = '<table border="1" cellpadding="2" cellspacing="2" align="center" nobr="true">
 <thead>
  <tr>
  <th colspan="7" align="center">'.$data_presentation['title'].'</th>
 </tr>
 <tr style="background-color:white;color:#0000FF;font-size: small;">
  <td align="center">'.$data_presentation['title2'].'</td>
...
$tbl = '<table border="1" cellpadding="2" cellspacing="2" align="center" nobr="true">
 <thead>
  <tr>
  <th colspan="7" align="center">JUNTA DIRECTIVA PROVINCIAL </th>
 </tr>
 <tr style="background-color:white;color:#0000FF;font-size: small;">
...
if(get_porcen($data_sumatorio['si'],$data_sumatorio['socios'])>get_porcen($data_sumatorio['noo'],$data_sumatorio['socios'])) {
